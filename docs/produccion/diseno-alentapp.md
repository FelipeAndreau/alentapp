...
## 9. Extensión de Observabilidad — Entidades Sport y Enrollment (MaxiC55)

### 9.1 Métricas RED — SportController
...
### 9.2 Métricas RED — EnrollmentController
...
### 9.4 Alertas Prometheus

Agregadas al `observability/prometheus/rules.yml` (grupos `alentapp-sports` y `alentapp-enrollments`):
...
### 9.5 Seguridad — Helmet y Rate Limiting
...
- Si se supera el límite, Fastify responde con `429 Too Many Requests`
